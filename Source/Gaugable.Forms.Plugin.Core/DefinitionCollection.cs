...
{
	/// <summary>
	/// Definition collection. Taken from Xamarin.Forms since the constructor is internal to their assemly.
	/// </summary>
	public class DefinitionCollection<T> : IList<T>, ICollection<T> where T : Xamarin.Forms.IDefinition
	{
